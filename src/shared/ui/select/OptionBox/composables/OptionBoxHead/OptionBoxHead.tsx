...
import { cn, isValueEmpty, resultIf } from "@/src/shared/utils/functions";
...
const OptionBoxHead = ({ placeholder, children, ArrowElement, ...props }: PropsWithChildren<Props>) => {
    const headRef = useRef<HTMLDivElement | null>(null);
    const { selectedOption, renderHead, active, toggle, setActive, id }: OptionBoxContextType = useOptionBoxContext();
